...
export const headerMenu = [
    ...
    { name: 'Team', link: '/team' },
    { name: 'Register', link: 'https://training.causeofdeathindia.com/join-us-as-va-coder/', target: '_blank'},
    ...
    { name: 'Login', link: 'https://training.causeofdeathindia.com/login/', target: '_blank'},
];
